    ...
    <div class="container-fluid">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 text-right">
                     <a href="{{route('sub_admin.products.index')}}"><button class="btn btn-primary">Back</button></a>       
             </div>
        </div>
     </div>
</section>
<section class="content">
    <div class="container-fluid">
        <form action="{{route('sub_admin.products.update',$product->id)}}" method="post" name="" id="">
          @csrf
          @method('put')
            <div class="row">
               <div class="col-md-6">
