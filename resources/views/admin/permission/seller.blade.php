            ...
            @foreach ($sellers as $user)
                <tr>
                    ...
                    @if ($user->email_verified_at == null)
                        <a href="{{route('seller.approved',$user->id)}}"><button class="btn btn-primary">Approved</button></a>
                    @else
                        <a href="{{route('seller.disapproved',$user->id)}}"><button class="btn btn-danger">Disapproved</button></a>
                    @endif
                    <a href="{{route('seller.permission',$user->id)}}"><button class="btn btn-success">Permission</button></a>
                    </td>
                </tr>
            @endforeach
            @endif
