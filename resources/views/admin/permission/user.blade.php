            ...
            @foreach ($users as $user)
                <tr>
                    ...
                    @if ($user->email_verified_at == null)
                        <a href="{{route('customer.approved',$user->id)}}"><button class="btn btn-primary">Approved</button></a>
                    @else
                        <a href="{{route('customer.disapproved',$user->id)}}"><button class="btn btn-danger">Disapproved</button></a>
                    @endif
